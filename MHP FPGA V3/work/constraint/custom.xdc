...
set_property PACKAGE_PIN C3 [get_ports {carry}]
set_property IOSTANDARD LVCMOS33 [get_ports {carry}]
set_property PULLDOWN true [get_ports {carry}]
set_property PACKAGE_PIN C1 [get_ports {sum}]
set_property IOSTANDARD LVCMOS33 [get_ports {sum}]
set_property PULLDOWN true [get_ports {sum}]
